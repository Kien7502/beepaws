      ...
      >
          ...
          {!hydrated ? (
            ...
            <div className="space-y-4">
              {[1, 2].map((n) => (
                ...
                >
                  <div className="h-20 w-20 shrink-0 rounded-xl bg-slate-200 dark:bg-slate-700" />
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
                Add something for your furry friend!
              </p>
              <Link
                    ...
                    <div className="flex min-w-0 flex-1 flex-col">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <button
                          ...
                          className="shrink-0 rounded-lg p-1.5 text-slate-400 transition-colors hover:bg-rose-50 hover:text-rose-500 dark:hover:bg-rose-950/30"
                      ...
                      <div className="mt-2 flex items-center justify-between gap-2">
                        <div className="inline-flex items-center rounded-xl border border-[var(--color-border)] text-sm">
                          ...
                          <span className="min-w-[1.75rem] text-center font-bold">
                            {item.quantity}
                          </span>
                          <button
                            type="button"
        ...
        {hydrated && items.length > 0 && (
          <div className="border-t border-[var(--color-border)] bg-[var(--color-surface)] px-5 py-5">
            ...
            {/* Fallback when Shopify cart isn't ready yet */}
